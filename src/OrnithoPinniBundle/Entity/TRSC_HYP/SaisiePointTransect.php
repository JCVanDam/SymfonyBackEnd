 ...
 * SaisiePointTransect
 *
 * @ORM\Table(name="trsc_hyp_saisie_point_transect")
 * @ORM\Entity(repositoryClass="OrnithoPinniBundle\Repository\TRSC_HYP\SaisiePointTransectRepository")
 */
class SaisiePointTransect
{
     ...
     * @ORM\JoinColumn(name="trsc_hyp_observations_id", referencedColumnName="id", nullable=false)
     * @Assert\Valid
     */
     ...
     * Set protocole.
     *
     * @param \OrnithoPinniBundle\Entity\TRSC_HYP\Protocole|null $protocole
     *
     * @return SaisiePointTransect
     */
    public function setProtocole(\OrnithoPinniBundle\Entity\TRSC_HYP\Protocole $protocole = null)
    {
     ...
     * Add observation.
     *
     * @param \OrnithoPinniBundle\Entity\TRSC_HYP\Observation $observation
     *
     * @return SaisiePointTransect
     */
    public function addObservation(\OrnithoPinniBundle\Entity\TRSC_HYP\Observation $observation)
    {
     ...
     */
    public function removeObservation(\OrnithoPinniBundle\Entity\TRSC_HYP\Observation $observation)
    {
