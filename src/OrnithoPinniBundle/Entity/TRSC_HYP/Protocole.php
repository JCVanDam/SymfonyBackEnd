 ...
 * Protocole
 *
 * @ORM\Table(name="trsc_hyp_protocole")
 * @ORM\Entity(repositoryClass="OrnithoPinniBundle\Repository\TRSC_HYP\ProtocoleRepository")
 */
class Protocole
{
  /**
   ...
   * @ORM\JoinColumn(name="trsc_hyp_saisie_id", referencedColumnName="id", nullable=false)
   * @Assert\Valid
   */
  private $saisies;
  ...
  public function __toString(){
     ...
     * Set transect.
     *
     * @param \OrnithoPinniBundle\Entity\TRSC_HYP\TransectGPS|null $transect
     *
     * @return Protocole
     */
    public function setTransect(\OrnithoPinniBundle\Entity\TRSC_HYP\TransectGPS $transect = null)
    {
     ...
     * Get transect.
     *
     * @return \OrnithoPinniBundle\Entity\TRSC_HYP\TransectGPS|null
     */
     ...
     * Add saisy.
     *
     * @param \OrnithoPinniBundle\Entity\TRSC_HYP\SaisiePointTransect $saisy
     *
     * @return Protocole
     */
    public function addSaisy(\OrnithoPinniBundle\Entity\TRSC_HYP\SaisiePointTransect $saisy)
    {
     ...
     */
    public function removeSaisy(\OrnithoPinniBundle\Entity\TRSC_HYP\SaisiePointTransect $saisy)
    {
